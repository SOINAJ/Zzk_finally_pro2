...
public class Works_Util {
    ...
    public static Goods_zzk GoodsUtil(String data) {
        Goods_zzk goods_zzk = new Goods_zzk();
        try {
...
//            complain.setMessage(need_data[2]);
    ...
    public static Complain_zzk ComplainUtil(String data) {
        Complain_zzk complain = new Complain_zzk();
        try {
            String[] this_data = data.split("&");
            String[] need_data = new String[this_data.length];
