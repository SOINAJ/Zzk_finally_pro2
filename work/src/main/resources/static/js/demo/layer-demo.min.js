        ...
        switch (e.demo1.animate({scrollTop: e.demo1.scrollTop() + n}, 0), a) {
            ...
            case 1:
                ...
                !function p() {
                    ...
                    9 === ++o && parent.layer.confirm("怎么样，是否很喜欢该皮肤，去下载？", {skin: "layer-ext-moon"}, function (e, t) {
            ...
            case 8:
                ...
                break;
            case 11:
                var i = parent.layer.load(0, {shade: !1});
                setTimeout(function () {
                    parent.layer.close(i)
                }, 5e3);
                break;
            case 12:
                var l = parent.layer.load(1, {shade: [.1, "#fff"]});
                setTimeout(function () {
            ...
            case 13:
                ...
                break;
            case 14:
                parent.layer.prompt({title: "输入任何口令，并确认", formType: 1}, function (e) {
                    parent.layer.prompt({title: "随便写点啥，并确认", formType: 2}, function (t) {
